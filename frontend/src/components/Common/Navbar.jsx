...
const Navbar = () => {
  const [drawerOpen, setDrawerOpen] = useState(false); //kiểm soát việc mở/đóng CartDrawer
  const [navDrawerOpen, setNavDrawerOpen] = useState(false); //kiểm soát việc mở/đóng menu điều hướng trên mobile
      ...
      <nav className="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button onClick={toggleCartDrawer} className="relative hover:text-black">
            ...
            <span className="absolute -top-1 bg-rabbit-red text-white text-xs rounded-full px-1.5 py-0.5">4</span>
          </button>
